...
namespace TMPro
{
 ...
 FallbackMaterial value;			if (m_fallbackMaterials.TryGetValue(num, out value))
			{
 ...
 FallbackMaterial value2; long value;				if (m_fallbackMaterialLookup.TryGetValue(instanceID, out value) && m_fallbackMaterials.TryGetValue(value, out value2))
				{
					value2.count++;
				}
			}
