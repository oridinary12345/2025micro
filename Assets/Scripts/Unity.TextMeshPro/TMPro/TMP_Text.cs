                ...
                case 41311:
                    {
                        ...
                        TMP_FontAsset fontAsset; if (!MaterialReferenceManager.TryGetFontAsset(valueHashCode3, out fontAsset))
                        {
                ...
                case 100149144:
                    {
                        ...
                        TMP_ColorGradient gradientPreset; if (MaterialReferenceManager.TryGetColorGradientPreset(valueHashCode5, out gradientPreset))
                        {
