...
namespace UnityEngine.UI.Extensions
{
 ...
 Vector2 localPoint;			if (handleContainerRect != null && handleContainerRect.rect.size[0] > 0f && RectTransformUtility.ScreenPointToLocalPointInRectangle(handleContainerRect, eventData.position, cam, out localPoint))
			{
		...
		public override void OnPointerDown(PointerEventData eventData)
		{
			...
			{
 Vector2 localPoint;				if (RectTransformUtility.ScreenPointToLocalPointInRectangle(m_HandleRect, eventData.position, eventData.pressEventCamera, out localPoint))
				{
					m_Offset = localPoint;
				}
